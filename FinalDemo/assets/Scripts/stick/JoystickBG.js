...
cc.Class({
    ...
    _allDirectionsMove: function () {
        this._playerNode.x += Math.cos(this._angle * (Math.PI / 180)) * this._speed * PlayerModule.StickSpeed;
        this._playerNode.y += Math.sin(this._angle * (Math.PI / 180)) * this._speed * PlayerModule.StickSpeed;
    },
